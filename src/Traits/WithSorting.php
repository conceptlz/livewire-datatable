...
use Conceptlz\ThunderboltLivewireTables\Traits\Configuration\SortingConfiguration;
use Conceptlz\ThunderboltLivewireTables\Traits\Helpers\SortingHelpers;
